...
double *H_SGS_X, double *H_SGS_Y, double *H_SGS_Z, double *D_SGS_X, double *D_SGS_Y, double *D_SGS_Z, double *TAU_SGS_XX, double *TAU_SGS_YY, double *TAU_SGS_ZZ, double *det, double *DUCROS)
{
	...
	double KS_x, KS_y, KS_z, TS_x, TS_y, TS_z;
	...
	temp = (1.4*Mach*Mach*0.4*((U[i][j][4]/U[i][j][0])-0.5*(((U[i][j][1]*U[i][j][1])/(U[i][j][0]*U[i][j][0]))+((U[i][j][2]*U[i][j][2])/(U[i][j][0]*U[i][j][0]))+((U[i][j][3]*U[i][j][3])/(U[i][j][0]*U[i][j][0])))));
	temp1 = sqrt(temp)*sqrt(temp)*sqrt(temp);
	/**************************************SUTHERLAND LAW***************************************************************************/
	mu[j][i] = (temp1)*((1.0+(110.4/Free_t))/(temp+(110.4/Free_t)));	
	/********************************************************************************************************************************/
	/*****************************************HEAT FLUX******************************************************************************/
